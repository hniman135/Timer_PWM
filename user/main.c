...
//  tmr_channel_value_set(TMR4, TMR_SELECT_CHANNEL_2, ccr1_val);
//
//  tmr_output_channel_config(TMR4, TMR_SELECT_CHANNEL_3, &tmr_oc_init_structure);
//  tmr_channel_value_set(TMR4, TMR_SELECT_CHANNEL_3, ccr2_val);
//
//  //tmr_period_buffer_enable(TMR4, TRUE);
//
//  /* tmr enable counter */
//  tmr_counter_enable(TMR4, TRUE);
//  tmr_interrupt_enable(TMR4, TMR_C2_INT | TMR_C3_INT , TRUE);
//
//  while(1)
//  {
//  }
